...
public class ShlamaModel<T extends AnimalEntity> extends AnimalModel<T> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData antler = head.addChild("antler", ModelPartBuilder.create().uv(40, 44).mirrored().cuboid(4.0F, -2.0F, 2.0F, 2.0F, 2.0F, 2.0F, new Dilation(0.0F)).mirrored(false)
                ...
                .uv(48, 39).mirrored().cuboid(-2.0F, -2.0F, 0.0F, 2.0F, 7.0F, 2.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.pivot(-3.0F, -14.0F, -2.0F));

        ModelPartData ears = head.addChild("ears", ModelPartBuilder.create(), ModelTransform.pivot(-1.0F, -9.0F, 0.0F));

        ModelPartData ear_right_r1 = ears.addChild("ear_right_r1", ModelPartBuilder.create().uv(20, 43).cuboid(-6.3827F, 0.0761F, -2.0F, 6.0F, 1.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(-4.5F, 0.25F, 0.0F, 0.0F, 0.0F, 0.3927F));

        ModelPartData ear_left_r1 = ears.addChild("ear_left_r1", ModelPartBuilder.create().uv(20, 38).cuboid(-0.2326F, 0.1418F, -2.0F, 6.0F, 1.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(6.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.3927F));
        ...
        ModelPartData body = modelPartData.addChild("body", ModelPartBuilder.create().uv(0, 48).cuboid(-7.5F, -7.0F, -12.0F, 15.0F, 14.0F, 23.0F, new Dilation(0.0F)), ModelTransform.pivot(-1.5F, 3.0F, 1.0F));
    ...
    public void setAngles(T entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        ...
        this.ears.getChild("ear_left_r1").roll = (float) (-Math.PI / 6) - MathHelper.cos(l * 1.2F) * m;
        this.ears.getChild("ear_right_r1").roll = (float) (Math.PI / 6) + MathHelper.cos(l) * m;
